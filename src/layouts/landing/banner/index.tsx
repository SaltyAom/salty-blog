...
const Banner = () => (
    <header className={`${styles['banner-container']} w-full`}>
        ...
        >
            <section
                className={`${styles['banner-content']} mt-8 sm:mt-0 flex flex-col`}
            >
                <h1 className="text-4xl text-gray-700 dark:text-gray-100 m-0 mb-4 sm:mb-1 font-medium leading-snug">
                    Blog ของ Dev ที่ชอบ
                    <mark
                        className="bg-transparent border-0 border-b-4 border-solid color-current border-blue-400"
